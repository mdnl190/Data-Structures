...
int main()
{
  ...
  DynamicArray <int> yoArray(20);
  vector<int> values;

  //header
  cout << "Lab 4a, Dynamic Array Program \nProgrammer: Mary Latif" << endl << endl;
  ...
  //function testing
  {
    ...
    cout << "\nTesting the capacity funtion. I expect the capacity to be 10";
    cout << "\n\tActual result: " << myArray.capacity() << endl;
    assert(10 == myArray.capacity());
    cout << "\nTesting the capacity funtion pt 2. I expect the capacity to be 20";
  ...
  // object copy testing
  {
    DynamicArray<double> copy = myArray;
    //const DynamicArray<double> copy = myArray;
  ...
  {
    DynamicArray<double> copy; copy = myArray;
